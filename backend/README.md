...
## Project Structure
    ...
    ├── testapiautosetting_123659  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123659`
...
2. Clone this repo and `cd testapiautosetting_123659`
